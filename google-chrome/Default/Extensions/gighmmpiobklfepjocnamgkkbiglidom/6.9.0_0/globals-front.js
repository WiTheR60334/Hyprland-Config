...
var browser_polyfill = __webpack_require__(838);
...
function send(type, args = {}) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield browser_polyfill_default().runtime.sendMessage(Object.assign(Object.assign({}, args), { type }));
    });
}
...
function start() {
    ...
    self.modulesAsGlobal = { messaging: front_namespaceObject };
}
start();
